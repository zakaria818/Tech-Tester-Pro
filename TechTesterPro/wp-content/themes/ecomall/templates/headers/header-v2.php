...
<header class="ts-header <?php echo esc_attr(implode(' ', $header_classes)); ?>">
	<div class="header-template">
		...
		<div class="header-top hidden-phone">
			<div class="container">
				<?php if( $ecomall_theme_options['ts_header_currency'] || $ecomall_theme_options['ts_header_language']): ?>
				...
				<div class="header-center"><?php ecomall_store_notices(); ?></div>
				...
				<div class="container">
					...
					<div class="header-right">
						<?php if( class_exists('YITH_WCWL') && $ecomall_theme_options['ts_enable_tiny_wishlist'] ): ?>
							<div class="my-wishlist-wrapper hidden-ipad"><?php echo ecomall_tini_wishlist(); ?></div>
						<?php endif; ?>
		...
		<div class="header-bottom hidden-phone">
			<div class="container">
				...
				<div class="header-right">
					<?php ecomall_hotline(); ?>
					<?php if( class_exists('YITH_WCWL') && $ecomall_theme_options['ts_enable_tiny_wishlist'] ): ?>
						<div class="my-wishlist-wrapper visible-ipad"><?php echo ecomall_tini_wishlist(); ?></div>
					<?php endif; ?>
				</div>
			</div>					
		</div>
